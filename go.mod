...
replace (
	...
	github.com/forbole/juno/v6 => github.com/CoreumFoundation/junov5/v6 v6.0.0-20241216105105-8b46c0519796
)
...
require (
	...
	github.com/CoreumFoundation/coreum/v5 v5.0.0-20241216105637-caea1e57b1a3
